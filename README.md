...
For Daanys-Diner, the questions are :
...
To create the database for Daanys-Diner, Copy the below code:
The code will work in pgadmin4, Not in MMYsql, as it doesnot have schema
